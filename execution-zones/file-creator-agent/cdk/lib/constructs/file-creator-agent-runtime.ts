/**
 * File Creator Agent AgentCore Runtime construct.
 *
 * @module execution-zones/execution-agent/cdk/lib/constructs/file-creator-agent-runtime
 */
...
export interface FileCreatorAgentRuntimeProps {
...
export class FileCreatorAgentRuntime extends Construct {
  public readonly runtime: cdk.CfnResource;
  public readonly endpoint: cdk.CfnResource | undefined = undefined;
  public readonly executionRole: iam.Role;
  public readonly runtimeArn: string;

  constructor(scope: Construct, id: string, props: FileCreatorAgentRuntimeProps) {
    super(scope, id);

    const stack = cdk.Stack.of(this);

    this.executionRole = new iam.Role(this, "FileCreatorRole", {
      roleName: `${stack.stackName}-FileCreatorRole`,
      ...
      description:
        "Execution role for File Creator Agent AgentCore Runtime with Bedrock, ECR, CloudWatch, and X-Ray permissions",
    });
