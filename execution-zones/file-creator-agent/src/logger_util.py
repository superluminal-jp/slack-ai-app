"""
Structured JSON logging for Execution Agent (CloudWatch).
...
def get_logger() -> logging.Logger:
    """Return the configured Execution Agent logger."""
