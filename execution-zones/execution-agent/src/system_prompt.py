...
FULL_SYSTEM_PROMPT = (
    ...
    "(2) When creating a business document (proposal, executive summary), call get_business_document_guidelines first, "
    "then generate_text_file or generate_word.\n"
    "(3) When creating slides or a presentation, call get_presentation_slide_guidelines first, "
    "then generate_powerpoint or generate_chart_image.\n"
    "(4) When the user provides a URL or asks about web content, call fetch_url to retrieve it, then answer based on the content.\n"
    "(5) When the user asks for ツール一覧, 利用可能なツール, or a list of available tools, you MUST list ALL tools: "
