...
**目的**: Signing Secret 漏洩時の防御として Slack API Existence Check を採用した決定を記録する。
**対象読者**: 開発者、アーキテクト
**最終更新日**: 2026-02-14
...
- [セキュリティ要件](../security.md) - Existence Check要件
- [セキュリティ実装](../security.md) - 実装詳細とコード
- [脅威モデル](../security.md) - T-01脅威分析
- [テストと検証](../testing.md) - Existence Checkテストシナリオ
