"""
Docs Agent A2A Server — FastAPI on port 9000.

Receives JSON-RPC 2.0 payloads from Verification Agent and returns docs-focused responses.
"""
...
def _log(level: str, event_type: str, data: dict) -> None:
    ...
    log(_logger, level, event_type, data, service="docs-agent")


def handle_message_tool(payload_json: str) -> str:
    """Process A2A message with docs search tool and return formatted response JSON."""
