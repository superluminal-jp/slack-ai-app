"""
Structured JSON logging for Doc Search Agent (CloudWatch).
...
def get_logger() -> logging.Logger:
    """Return the configured Doc Search Agent logger."""
