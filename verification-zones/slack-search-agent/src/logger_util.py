"""
Structured JSON logging for Slack Search Agent (CloudWatch).
...
LOGGER_NAME = "slack-search-agent"
...
def get_logger() -> logging.Logger:
    """Return the configured Slack Search Agent logger."""
...
def log(
    ...
    data: dict,
    *,
    service: str = "slack-search-agent",
) -> None:
