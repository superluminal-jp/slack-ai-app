...
def check_rate_limit(
    ...
    if limit is None:
        ...
        try:
            ...
            log_warn("rate_limit_config_invalid", {
    ...
    window_start = (current_time // window_seconds) * window_seconds  # Align to window boundary
    ...
    try:
        ...
        if not table:
            ...
            log_warn("rate_limit_table_not_configured", {
        ...
        try:
            response = table.update_item(
                ...
                ExpressionAttributeValues={
                    ...
                    ":inc": 1,
                    ":limit": limit,
                    ":ttl": current_time + window_seconds + 300,  # TTL = window_end + 5 minutes buffer
            ...
            log_info("rate_limit_check_allowed", {
                "rate_limit_key": rate_limit_key,
            ...
            if error_code == "ConditionalCheckFailedException":
                ...
                log_error("rate_limit_dynamodb_error", {
                    "rate_limit_key": rate_limit_key,
        ...
        log_error("rate_limit_unexpected_error", {
            "rate_limit_key": rate_limit_key,
        }, e)
        return True, None
